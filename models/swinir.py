...
@register('lightweight-swinir')
def make_swinir(no_upsampling=True , depth_num = 1,sub_num = 6, channel_ratio= 1.):
    return SwinIR(img_range=1., depths=[6, 6, 6, 6], embed_dim=60, num_heads=[6, 6, 6, 6],
